...
import com.transing.crawl.util.processor.impl.autoHomeAnalysis.AnalysisXML;
...
public class WebUtilTest {
    ...
    public void getWeiboTest() throws Exception{
        String hql="id=3262116493&type=0&refer_flag=1087030202_2975_5011_0";
        String reges="id=(\\d+)&.*";
        String t=ParseUtil.regexMatcher(reges,hql).get(0).toString();
        System.out.println(t);
    }

  @Test
    public void getDownTTF(){
      /*DownParseTTF d = new DownParseTTF();
      d.parseTTF("");*/
  }
    @Test
    public void getAnaly(){
        AnalysisXML analysisXML = new AnalysisXML();
        Map map = analysisXML.parseXML("1111");
