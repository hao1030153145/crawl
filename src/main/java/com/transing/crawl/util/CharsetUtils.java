...
public class CharsetUtils
{
    ...
    private static String [] charsetArr=new String[]{"utf-8","GBK","unicode","ISO-8859-1","ASCII"};
            ...
            throws Exception
    {
        ...
        if("ISO-8859-1".equalsIgnoreCase(newCharset)){
            return new String(contentByte,"ISO-8859-1");
        }
        if("ASCII".equalsIgnoreCase(newCharset)){
            return new String(contentByte,"ASCII");
        }
